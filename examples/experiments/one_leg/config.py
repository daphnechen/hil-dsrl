...
class EnvConfig(DefaultEnvConfig):
    ...
    RESET_POSE = np.array([0.47, -0.04, 0.14, np.pi, 0, np.pi])

    # Step 2: add bounding boxes
    ABS_POSE_LIMIT_LOW  = np.array([0.4, -0.2, 0.03, np.pi - 0.05, -np.pi+0.05, np.pi - 0.05])
    ABS_POSE_LIMIT_HIGH = np.array([0.6,  0.2, 0.15, np.pi + 0.05,  np.pi-0.05, np.pi + 0.05])
    # ABS_POSE_LIMIT_LOW  = np.array([0.42, -0.15, 0.06, np.pi - 0.05, -0.05, np.pi / 2 - 0.05])
    # ABS_POSE_LIMIT_HIGH = np.array([0.59,  0.16, 0.15, np.pi + 0.05,  0.05, np.pi / 2 + 0.05])
