...
sudo python record_demos.py --exp_name=pen_in_bowl --successes_needed=10
```
- Use spacemouse to control robot
- Press **'s'** to mark successful trajectory
- Press **'f'** to mark failure and reset early
- Demos saved to: `./demo_data/pen_in_bowl_10_demos_<timestamp>.pkl`
...
### Terminal 2 - Learner
```bash
cd /home/daphne/Desktop/jax-hitl-hil-serl/examples/experiments/pen_in_bowl
./run_steer_learner.sh --demo_path=../../demo_data/pen_in_bowl_10_demos.pkl
```
...
```bash
cd /home/daphne/Desktop/jax-hitl-hil-serl/examples/experiments/pen_in_bowl
./run_hgdagger_learner.sh --demo_path=../../demo_data/pen_in_bowl_10_demos.pkl
```
