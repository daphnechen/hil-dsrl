...
from experiments.banana.wrapper import BananaEnv
...
class EnvConfig(DefaultEnvConfig):
    ...
    RESET_POSE = np.array([0.43110592574301737,-0.13743858171465298,0.4783615112779517,3.133378603564556,0.06800796435598633,0.7390535310454089])
    ...
    RESET_POSE = np.array([0.460824921132198,-0.04455344233515247,0.3693175648949239,-3.0396523955192585,-0.05323284929406502,0])
